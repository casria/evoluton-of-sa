01. The data in *.fq.gz format was aligned with the Nipponbare genome (https://rapdb.dna.affrc.go.jp/download/irgsp1.html) and the output files were gvcf and vcf.
